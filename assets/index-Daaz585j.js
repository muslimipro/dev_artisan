import{a2 as l,b as t,e as i,W as a,a6 as p,D as d,t as u,K as o,ab as b}from"./index-DGYhlJPA.js";var m=function(r){var e=r.dt;return`
.p-progressbar {
    position: relative;
    overflow: hidden;
...
`)},c={root:function(r){var e=r.instance;return["p-progressbar p-component",{"p-progressbar-determinate":e.determinate,"p-progressbar-indeterminate":e.indeterminate}]},value:"p-progressbar-value",label:"p-progressbar-label"},g=l.extend({name:"progressbar",theme:m,classes:c}),v={name:"BaseProgressBar",extends:b,props:{value:{type:Number,default:null},mode:{type:String,default:"determinate"},showValue:{type:Boolean,default:!0}},style:g,provide:function(){return{$pcProgressBar:this,$parentInstance:this}}},h={name:"ProgressBar",extends:v,inheritAttrs:!1,computed:{progressStyle:function(){return{width:this.value+"%",display:"flex"}},indeterminate:function(){return this.mode==="indeterminate"},determinate:function(){return this.mode==="determinate"}}},f=["aria-valuenow"];function y(n,r,e,k,w,s){return t(),i("div",a({role:"progressbar",class:n.cx("root"),"aria-valuemin":"0","aria-valuenow":n.value,"aria-valuemax":"100"},n.ptmi("root")),[s.determinate?(t(),i("div",a({key:0,class:n.cx("value"),style:s.progressStyle},n.ptm("value")),[n.value!=null&&n.value!==0&&n.showValue?(t(),i("div",a({key:0,class:n.cx("label")},n.ptm("label")),[p(n.$slots,"default",{},function(){return[d(u(n.value+"%"),1)]})],16)):o("",!0)],16)):s.indeterminate?(t(),i("div",a({key:1,class:n.cx("value")},n.ptm("value")),null,16)):o("",!0)],16,f)}h.render=y;export{h as s};
