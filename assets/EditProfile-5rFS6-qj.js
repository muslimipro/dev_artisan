import{s as ve}from"./index-D7vQivom.js";import{B as ae,W as G,U as Q,Z as N,az as $,au as A,O as ge,aI as ye,y as be,z as Oe,A as we,C as Ie,D as Se,E as ke,aq as Ce,aG as X,a5 as xe,G as Le,aK as Me,an as Ke,H as R,ao as De,o as c,c as v,f as F,as as z,aS as Ve,h as D,x as u,F as U,i as Y,I as S,b as s,w as m,e as h,J as le,t as C,T as Ae,aA as Te,g as B,ap as ze,ae as Ee,d as re,aB as ee,r as K,j as E,u as Fe,a as Be,ah as Pe,aU as $e,s as Re}from"./index-CD-RZOao.js";import{s as je}from"./index-D-6faoFu.js";import{a as Ge,c as Ue,s as He}from"./index-7N8pAeDB.js";import{s as se,a as ue}from"./index-BPDWqoRL.js";import{s as ce,a as Ne}from"./index-Ljzkmy5v.js";import{s as qe}from"./index-BD-rH53-.js";import{s as _e}from"./index-CYFlAKNq.js";import{s as We}from"./index-Dj2HcMJw.js";import{S as te}from"./index-DOT7IeUi.js";import{a as Je}from"./index-B30go9wG.js";import{s as Ze}from"./index-DL9t1mXc.js";import{_ as Qe}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-CHdp4beW.js";import"./index-CuINv_ZP.js";import"./index-DBBDKR6P.js";import"./index-DBceM-0I.js";var Xe=function(e){var n=e.dt;return`
.p-autocomplete {
    display: inline-flex;
}
...
`)},Ot={root:function(e){var n=e.props;return["p-avatar p-component",{"p-avatar-image":n.image!=null,"p-avatar-circle":n.shape==="circle","p-avatar-lg":n.size==="large","p-avatar-xl":n.size==="xlarge"}]},label:"p-avatar-label",icon:"p-avatar-icon"},wt=ae.extend({name:"avatar",theme:bt,classes:Ot}),It={name:"BaseAvatar",extends:Ee,props:{label:{type:String,default:null},icon:{type:String,default:null},image:{type:String,default:null},size:{type:String,default:"normal"},shape:{type:String,default:"square"},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:wt,provide:function(){return{$pcAvatar:this,$parentInstance:this}}},pe={name:"Avatar",extends:It,inheritAttrs:!1,emits:["error"],methods:{onError:function(e){this.$emit("error",e)}}},St=["aria-labelledby","aria-label"],kt=["src","alt"];function Ct(t,e,n,i,a,o){return c(),v("div",u({class:t.cx("root"),"aria-labelledby":t.ariaLabelledby,"aria-label":t.ariaLabel},t.ptmi("root")),[S(t.$slots,"default",{},function(){return[t.label?(c(),v("span",u({key:0,class:t.cx("label")},t.ptm("label")),C(t.label),17)):t.$slots.icon?(c(),F(le(t.$slots.icon),{key:1,class:z(t.cx("icon"))},null,8,["class"])):t.icon?(c(),v("span",u({key:2,class:[t.cx("icon"),t.icon]},t.ptm("icon")),null,16)):t.image?(c(),v("img",u({key:3,src:t.image,alt:t.ariaLabel,onError:e[0]||(e[0]=function(){return o.onError&&o.onError.apply(o,arguments)})},t.ptm("image")),null,16,kt)):D("",!0)]})],16,St)}pe.render=Ct;const xt=re({__name:"LocationInput",props:{country:{},countryModifiers:{},city:{},cityModifiers:{}},emits:["update:country","update:city"],setup(t){const e="artisan_education",n=ee(t,"country"),i=ee(t,"city"),a=K([]),o=K([]);async function y(I){const d=I.query.toLowerCase();if(d.length<2){a.value=[];return}const L=await(await fetch("https://restcountries.com/v3.1/all")).json();a.value=L.map(r=>{const f=r.translations||{},p=[{lang:"eng",name:r.name.common},...Object.entries(f).map(([l,k])=>({lang:l,name:k.common}))].find(l=>l.name.toLowerCase().includes(d));return p?{name:p.name,code:r.cca2}:null}).filter(Boolean)}async function w(I){if(!n.value||I.query.length<3){o.value=[];return}const x=await(await fetch(`https://secure.geonames.org/searchJSON?name_startsWith=${I.query}&maxRows=10&country=${n.value.code}&username=${e}`)).json(),L=new Map(x.geonames.map(r=>[r.name.toLowerCase(),r]));o.value=Array.from(L.values()).map(r=>({name:r.name}))}return(I,d)=>{const x=se,L=ue;return c(),v(U,null,[s(L,null,{default:m(()=>[s(x,null,{default:m(()=>d[2]||(d[2]=[h("i",{class:"pi pi-flag"},null,-1)])),_:1}),s(E(W),{modelValue:n.value,"onUpdate:modelValue":d[0]||(d[0]=r=>n.value=r),suggestions:a.value,optionLabel:"name",onComplete:y,placeholder:"Country"},null,8,["modelValue","suggestions"])]),_:1}),s(L,null,{default:m(()=>[s(x,null,{default:m(()=>d[3]||(d[3]=[h("i",{class:"pi pi-building"},null,-1)])),_:1}),s(E(W),{modelValue:i.value,"onUpdate:modelValue":d[1]||(d[1]=r=>i.value=r),suggestions:o.value,optionLabel:"name",onComplete:w,placeholder:"City"},null,8,["modelValue","suggestions"])]),_:1})],64)}}}),Lt={key:1,class:"flex gap-2 flex-wrap items-center"},Mt={class:"flex-1 flex flex-col gap-4 items-center mb-4"},Kt={class:"relative"},Dt={class:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"},Vt={class:"text-3xl"},At={class:"text-xl font-semibold"},Tt={class:"flex gap-2 justify-end"},zt={class:"flex-1 flex flex-col gap-2 min-w-52"},Et={class:"flex justify-end"},Ft=re({__name:"EditProfile",setup(t){const e=K(null),n=K(!1),i=K(!1),a=Fe(),o=Be(),{user:y}=Pe(o),w=K(null),I=K(null),d=K(null),x=K(null),L=K(["5","6","7","8","9","10","11","12"]);async function r(){var p;n.value=!0;try{const{data:l}=await te.getUserProfile();e.value=l,w.value=((p=e.value)==null?void 0:p.avatar_url)??null,I.value={name:e.value.country,code:""},d.value={name:e.value.city}}catch(l){console.log(l)}finally{n.value=!1}}async function f(){var p,l;if(e.value){i.value=!0;try{await te.updateUserProfile(e.value.name,((p=I.value)==null?void 0:p.name)??void 0,((l=d.value)==null?void 0:l.name)??void 0,e.value.school,w.value??void 0),a.add({severity:"success",summary:"Profile updated successfully",life:2e3})}catch(k){console.log(k),a.add({severity:"error",summary:"Profile update failed!",detail:k,life:2e3})}finally{i.value=!1}}}async function V(p){const l=p.files[0],k=new FormData;k.append("file",l);try{const{data:M}=await Je.uploadFile(k);w.value=M.presigned_url}catch(M){console.log(M)}}return $e(r),(p,l)=>{const k=We,M=pe,g=_e,b=qe,P=se,T=ce,H=ue,de=He,fe=je,he=Re,me=ve;return c(),F(me,{class:"flex-grow",header:"Edit profile"},{default:m(()=>{var J,Z;return[n.value?(c(),F(k,{key:0})):e.value?(c(),v("div",Lt,[h("div",Mt,[h("div",Kt,[s(M,{class:"w-40 h-40 border",shape:"circle",image:w.value??void 0},null,8,["image"]),h("div",Dt,[s(g,{mode:"basic",customUpload:"",auto:"",onSelect:V,"choose-icon":w.value==null?"pi pi-plus":"pi pi-pencil",class:"p-button-link p-button-secondary p-button-rounded w-10 h-10"},null,8,["choose-icon"])])]),h("label",Vt,C(e.value.xp)+" xp",1),h("label",At,C((J=E(y))==null?void 0:J.email),1),h("div",Tt,[s(b,{severity:"secondary"},{default:m(()=>{var O;return[B(C((O=E(y))==null?void 0:O.user_type),1)]}),_:1}),s(b,{severity:(Z=E(y))!=null&&Z.access_type?"purple":"success"},{default:m(()=>{var O;return[B(C((O=E(y))==null?void 0:O.access_type),1)]}),_:1},8,["severity"]),s(b,{severity:e.value.verified?"success":"warn"},{default:m(()=>[B(C(e.value.verified?"verified":"not verified"),1)]),_:1},8,["severity"])])]),h("div",zt,[s(H,null,{default:m(()=>[s(P,null,{default:m(()=>l[6]||(l[6]=[h("i",{class:"pi pi-user-edit"},null,-1)])),_:1}),s(T,{id:"name",modelValue:e.value.name,"onUpdate:modelValue":l[0]||(l[0]=O=>e.value.name=O),autocomplete:"off",variant:"filled",class:"w-full",placeholder:"Name"},null,8,["modelValue"])]),_:1}),s(xt,{country:I.value,"onUpdate:country":l[1]||(l[1]=O=>I.value=O),city:d.value,"onUpdate:city":l[2]||(l[2]=O=>d.value=O)},null,8,["country","city"]),s(H,null,{default:m(()=>[s(P,null,{default:m(()=>l[7]||(l[7]=[h("i",{class:"pi pi-building-columns"},null,-1)])),_:1}),s(T,{id:"school",modelValue:e.value.school,"onUpdate:modelValue":l[3]||(l[3]=O=>e.value.school=O),autocomplete:"off",variant:"filled",class:"w-full",placeholder:"School"},null,8,["modelValue"])]),_:1}),s(H,null,{default:m(()=>[s(P,null,{default:m(()=>l[8]||(l[8]=[h("i",{class:"pi pi-graduation-cap"},null,-1)])),_:1}),s(de,{modelValue:x.value,"onUpdate:modelValue":l[4]||(l[4]=O=>x.value=O),options:L.value,class:"w-full",placeholder:"Grade",showClear:""},null,8,["modelValue","options"])]),_:1})])])):D("",!0),s(fe),h("div",Et,[s(he,{label:"Save profile",class:"justify-center",onClick:l[5]||(l[5]=O=>f()),loading:i.value,disabled:i.value},null,8,["loading","disabled"])])]}),_:1})}}}),en=Qe(Ft,[["__scopeId","data-v-4d61184a"]]);export{en as default};
