import{B as l,o as t,c as e,x as s,v as i,t as c,f as p,C as v,R as g,h as d,y as u}from"./index-DwUtLDwy.js";var h=function(r){var a=r.dt;return`
.p-avatar {
    display: inline-flex;
    align-items: center;
...
`)},m={root:function(r){var a=r.props;return["p-avatar p-component",{"p-avatar-image":a.image!=null,"p-avatar-circle":a.shape==="circle","p-avatar-lg":a.size==="large","p-avatar-xl":a.size==="xlarge"}]},label:"p-avatar-label",icon:"p-avatar-icon"},f=l.extend({name:"avatar",theme:h,classes:m}),b={name:"BaseAvatar",extends:u,props:{label:{type:String,default:null},icon:{type:String,default:null},image:{type:String,default:null},size:{type:String,default:"normal"},shape:{type:String,default:"square"},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:f,provide:function(){return{$pcAvatar:this,$parentInstance:this}}},y={name:"Avatar",extends:b,inheritAttrs:!1,emits:["error"],methods:{onError:function(r){this.$emit("error",r)}}},z=["aria-labelledby","aria-label"],w=["src","alt"];function S(n,r,a,k,$,o){return t(),e("div",i({class:n.cx("root"),"aria-labelledby":n.ariaLabelledby,"aria-label":n.ariaLabel},n.ptmi("root")),[s(n.$slots,"default",{},function(){return[n.label?(t(),e("span",i({key:0,class:n.cx("label")},n.ptm("label")),c(n.label),17)):n.$slots.icon?(t(),p(g(n.$slots.icon),{key:1,class:v(n.cx("icon"))},null,8,["class"])):n.icon?(t(),e("span",i({key:2,class:[n.cx("icon"),n.icon]},n.ptm("icon")),null,16)):n.image?(t(),e("img",i({key:3,src:n.image,alt:n.ariaLabel,onError:r[0]||(r[0]=function(){return o.onError&&o.onError.apply(o,arguments)})},n.ptm("image")),null,16,w)):d("",!0)]})],16,z)}y.render=S;export{y as s};
