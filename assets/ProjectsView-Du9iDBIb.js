import{_ as K,o as a,c as i,y as p,X as z,m,ab as J,a as u,t as Q,ac as G,k as g,a9 as xe,d as ce,ad as $e,j as ue,ae as pe,h as v,w as C,b as f,u as X,Y as ie,e as he,s as ve,r as Me,af as _e,i as Re,ag as je,f as ze,A as Ce,q as re,F as B,n as S,x as De}from"./index-DAM1Uh1E.js";import{s as Te}from"./index-Enrp3QUB.js";import{s as Be,a as Se,b as Ve,c as Pe}from"./index-uUkd-gHK.js";import{b as Le,s as Ee}from"./index-A0uT-A3z.js";import{_ as Xe}from"./AHeader.vue_vue_type_script_setup_true_lang-DGnRutpy.js";import{s as Ye}from"./logo-BGXpLYQ1.js";import{a as U,t as se}from"./types-B7fMVR9j.js";import{P as le}from"./pibody-BwAjMvHk.js";import{u as Ae}from"./editor-store-DzraGheD.js";import{u as Ie,m as Ue}from"./useSortable-D4TV1f97.js";import"./LocaleSwitcher.vue_vue_type_script_setup_true_lang-BMJdpnTe.js";import"./index-BSRFzKI8.js";var Ke=function(n){var t=n.dt;return`
...
`)},Je={root:"p-card p-component",header:"p-card-header",body:"p-card-body",caption:"p-card-caption",title:"p-card-title",subtitle:"p-card-subtitle",content:"p-card-content",footer:"p-card-footer"},Qe=K.extend({name:"card",theme:We,classes:Je}),Ze={name:"BaseCard",extends:J,style:Qe,provide:function(){return{$pcCard:this,$parentInstance:this}}},fe={name:"Card",extends:Ze,inheritAttrs:!1};function et(e,n,t,r,h,o){return a(),i("div",p({class:e.cx("root")},e.ptmi("root")),[e.$slots.header?(a(),i("div",p({key:0,class:e.cx("header")},e.ptm("header")),[z(e.$slots,"header")],16)):m("",!0),u("div",p({class:e.cx("body")},e.ptm("body")),[e.$slots.title||e.$slots.subtitle?(a(),i("div",p({key:0,class:e.cx("caption")},e.ptm("caption")),[e.$slots.title?(a(),i("div",p({key:0,class:e.cx("title")},e.ptm("title")),[z(e.$slots,"title")],16)):m("",!0),e.$slots.subtitle?(a(),i("div",p({key:1,class:e.cx("subtitle")},e.ptm("subtitle")),[z(e.$slots,"subtitle")],16)):m("",!0)],16)):m("",!0),u("div",p({class:e.cx("content")},e.ptm("content")),[z(e.$slots,"content")],16),e.$slots.footer?(a(),i("div",p({key:1,class:e.cx("footer")},e.ptm("footer")),[z(e.$slots,"footer")],16)):m("",!0)],16)],16)}fe.render=et;var tt=function(n){var t=n.dt;return`
.p-knob-range {
    fill: none;
...
`)},ut={root:function(n){var t=n.props;return["p-tag p-component",{"p-tag-info":t.severity==="info","p-tag-success":t.severity==="success","p-tag-warn":t.severity==="warn","p-tag-danger":t.severity==="danger","p-tag-secondary":t.severity==="secondary","p-tag-contrast":t.severity==="contrast","p-tag-rounded":t.rounded}]},icon:"p-tag-icon",label:"p-tag-label"},pt=K.extend({name:"tag",theme:ct,classes:ut}),ht={name:"BaseTag",extends:J,props:{value:null,severity:null,rounded:Boolean,icon:String},style:pt,provide:function(){return{$pcTag:this,$parentInstance:this}}},ye={name:"Tag",extends:ht,inheritAttrs:!1};function vt(e,n,t,r,h,o){return a(),i("span",p({class:e.cx("root")},e.ptmi("root")),[e.$slots.icon?(a(),g(xe(e.$slots.icon),p({key:0,class:e.cx("icon")},e.ptm("icon")),null,16,["class"])):e.icon?(a(),i("span",p({key:1,class:[e.cx("icon"),e.icon]},e.ptm("icon")),null,16)):m("",!0),e.value!=null||e.$slots.default?z(e.$slots,"default",{key:2},function(){return[u("span",p({class:e.cx("label")},e.ptm("label")),Q(e.value),17)]}):m("",!0)],16)}ye.render=vt;const mt={class:"h-[174px] overflow-hidden"},ft={class:"absolute top-2 left-2"},gt={key:0,class:"absolute top-0 right-0"},yt={key:0,class:"bg-yellow-500 text-white w-full px-2 py-[1px] rounded-bl-xl"},bt={key:1,class:"bg-green-500 text-white px-2 py-[1px] rounded-bl-xl"},kt={key:1,class:"absolute bottom-0 left-0"},wt={key:0,class:"bg-green-500 text-white w-full px-2 py-[1px] rounded-tr-xl"},xt={key:1,class:"bg-purple-500 text-white w-full px-2 py-[1px] rounded-tr-xl"},$t={key:2,class:"bg-blue-500 text-white w-full px-2 py-[1px] rounded-tr-xl"},Mt={key:3,class:"bg-red-500 text-white w-full px-2 py-[1px] rounded-tr-xl"},_t={class:"flex justify-between items-center px-4 py-1"},Rt={class:"flex items-center"},jt={key:0,class:"pi pi-crown text-purple-500 bg-purple-100 p-2 rounded-md mr-2"},zt={class:"py-3"},Ct={key:0,class:"flex"},Dt={key:1},W=ce({__name:"ProjectCard",props:{project:{}},emits:["after-remove"],setup(e,{emit:n}){const t=he(),r=$e(),h=ue(),{user:o}=pe(h),b=v(!1),l=e,Y=n;function k(){r.require({message:"Are you sure you want to Delete?",header:"Confirmation",icon:"pi pi-exclamation-triangle",rejectProps:{label:"Cancel",severity:"secondary",outlined:!0},acceptProps:{label:"Delete",severity:"danger"},accept:()=>{P()}})}async function P(){b.value=!0;try{await U.deleteProjectByID(l.project.id),Y("after-remove")}catch(x){console.log(x)}finally{b.value=!1}}function L(){t.push(`/project/${l.project.id}/edit`)}const D=v(l.project.cover_image.length>0?l.project.cover_image:le);function A(){l.project.cover_gif&&(D.value=l.project.cover_gif)}function I(){D.value=l.project.cover_image.length>0?l.project.cover_image:le}return(x,M)=>{const T=Ye,E=ye,w=ve,_=ge,F=Be,N=fe,$=Me("RouterLink");return a(),g($,{to:b.value?"":`/project/${l.project.id}`},{default:C(()=>[f(N,{style:{width:"300px",height:"234px",overflow:"hidden"},class:"relative p-0",dt:{body:{padding:"0px",gap:"2px"}}},{header:C(()=>{var R,j;return[u("div",mt,[f(T,{alt:"user header",src:D.value,class:"animate-fadein animate-once animate-duration-1000 animate-ease-in-out",onMouseover:A,onMouseleave:I},null,8,["src"]),u("div",ft,[l.project.level<3?(a(),g(E,{key:0,severity:"success",value:"Easy"})):l.project.level<5?(a(),g(E,{key:1,severity:"info",value:"Medium"})):l.project.level==5?(a(),g(E,{key:2,severity:"danger",value:"Hard"})):m("",!0)]),((R=X(o))==null?void 0:R.user_type)=="editor"?(a(),i("div",gt,[l.project.editing_status=="inreview"?(a(),i("div",yt,"In review")):(a(),i("div",bt,"Published"))])):m("",!0),((j=X(o))==null?void 0:j.user_type)=="editor"?(a(),i("div",kt,[l.project.access_type=="freemium"?(a(),i("div",wt,"Free")):l.project.access_type=="premium"?(a(),i("div",xt,"Premium")):l.project.access_type=="demo"?(a(),i("div",$t,"Demo")):l.project.access_type=="hackaton"?(a(),i("div",Mt,"Hackaton")):m("",!0)])):m("",!0)])]}),subtitle:C(()=>{var R;return[u("div",_t,[u("div",Rt,[l.project.access_type=="premium"?(a(),i("span",jt)):m("",!0),u("div",zt,Q(l.project.title),1)]),((R=X(o))==null?void 0:R.user_type)=="editor"?(a(),i("div",Ct,[f(w,{icon:"pi pi-pen-to-square",severity:"info",variant:"text",rounded:"","aria-label":"Edit",onClick:ie(L,["prevent"])}),f(w,{icon:"pi pi-trash",severity:"danger",variant:"text",rounded:"","aria-label":"Remove",onClick:ie(k,["prevent"]),disabled:b.value,loading:b.value},null,8,["disabled","loading"])])):(a(),i("div",Dt,[l.project.student_progress<100?(a(),g(_,{key:0,"model-value":l.project.student_progress,size:50,"value-template":j=>`${j}%`,readonly:"",valueColor:"orange"},null,8,["model-value","value-template"])):(a(),g(F,{key:1,label:x.$t("done"),icon:"pi pi-check",class:"bg-primary text-sm h-6 text-white font-semibold"},{icon:C(()=>M[0]||(M[0]=[u("i",{class:"pi pi-check text-white font-semibold",style:{"font-size":"12px"}},null,-1)])),_:1},8,["label"]))]))])]}),_:1})]),_:1},8,["to"])}}}),Tt={class:"flex flex-col min-h-screen bg-slate-50"},Bt={class:"flex gap-4 bg-slate-50 py-4 px-12 items-center"},St={class:"flex px-12 pb-4"},Vt={key:0,class:"text-2xl pr-4"},Pt={class:"border border-dashed rounded-xl border-green-400 overflow-hidden"},Lt={key:1,class:"flex flex-col gap-4 pb-8"},Et={key:0,class:"flex h-[256px] gap-2 px-3"},Xt={class:"flex px-12 pb-4"},Yt={class:"flex flex-wrap justify-center gap-8 px-12"},de=332,Qt=ce({__name:"ProjectsView",setup(e){const n=_e("el"),t=Re(),{locale:r}=je(),h=he(),o=Ae(),{addLesson:b}=o,l=ue(),{user:Y}=pe(l),k=v([]),P=v([]),L=v([]),D=v(0),A=v(0),I=v(0),x=v(!1),M=v(!1);Ie(n,k,{onUpdate:s=>{Ue(k.value,s.oldIndex,s.newIndex,s),De(async()=>{const d=[];k.value.map(y=>{const O=parseInt(y.id,10);d.push(O)});try{await U.changeProjectsOrder(d),t.add({severity:"success",summary:"Projects order saved!",life:2e3})}catch(y){t.add({severity:"error",summary:"Order set error!",detail:y,life:2e3})}})}});async function T(){if(!x.value){x.value=!0;try{const{data:s}=await U.getProjects();x.value=!1,k.value=[],D.value=s.length;for(const d of s)d.is_guidable?A.value++:I.value++;for(const d of s){const y=await se(d,r.value);k.value.push(y),y.is_guidable?P.value.push(y):L.value.push(y)}}catch(s){console.log(s)}finally{x.value=!1}}}ze(T),Ce(r,T);async function E(){M.value=!0;try{const{data:s}=await U.createProject(),d=await se(s,r.value);b(d),h.push(`/project/${d.id}/edit`)}catch(s){console.log(s)}finally{M.value=!1}}const w=v(""),_=v(null),F=()=>{_.value&&_.value.scrollBy({left:-de,behavior:"smooth"})},N=()=>{_.value&&_.value.scrollBy({left:de,behavior:"smooth"})},$=v(""),R=v(["Easy","Medium","Hard"]),j=v(""),be=v(["LED","switch","push-button","light-sensor","touch-sensor","potentiometer","encoder","motion-detector","microphone","climate-sensor","gyro-accel","buzzer","color-sensor","joystick","distance-sensor","servo"]);function Z(s){return s<3?"Easy":s<5?"Medium":s==5?"Hard":""}const ee=re(()=>P.value.filter(s=>(!$.value.length||$.value.includes(Z(s.level)))&&(!w.value||s.title.toLowerCase().includes(w.value.toLowerCase())))),ke=re(()=>L.value.filter(s=>(!$.value.length||$.value.includes(Z(s.level)))&&(!w.value||s.title.toLowerCase().includes(w.value.toLowerCase()))));return(s,d)=>{var ae,oe;const y=Se,O=Ee,we=Ve,te=Pe,ne=me,H=Te,q=ve;return a(),i("div",Tt,[f(Xe,{class:"sticky top-0 z-10"}),u("div",Bt,[f(we,null,{default:C(()=>[f(y,{class:"text-primary"},{default:C(()=>d[3]||(d[3]=[u("i",{class:"pi pi-search"},null,-1)])),_:1}),f(O,{type:"text",modelValue:w.value,"onUpdate:modelValue":d[0]||(d[0]=c=>w.value=c),placeholder:"Search",variant:"filled",class:"h-fit bg-white"},null,8,["modelValue"])]),_:1}),f(te,{modelValue:j.value,"onUpdate:modelValue":d[1]||(d[1]=c=>j.value=c),options:be.value,"max-selected-labels":3,placeholder:"Filter by modules",display:"chip",variant:"filled",class:"bg-white min-w-60"},null,8,["modelValue","options"]),f(te,{modelValue:$.value,"onUpdate:modelValue":d[2]||(d[2]=c=>$.value=c),options:R.value,placeholder:"Filter by level",display:"chip",variant:"filled",class:"bg-white min-w-60"},null,8,["modelValue","options"])]),u("div",St,[((ae=X(Y))==null?void 0:ae.user_type)!="editor"?(a(),i("div",Vt,"Learn")):m("",!0),f(ne)]),((oe=X(Y))==null?void 0:oe.user_type)=="editor"?(a(),i("div",{key:0,ref_key:"el",ref:n,class:"flex flex-wrap justify-center gap-8 px-12 pb-8"},[(a(!0),i(B,null,S(k.value,c=>(a(),g(W,{key:c.id,project:c,onAfterRemove:T},null,8,["project"]))),128)),(a(!0),i(B,null,S(D.value-k.value.length,c=>(a(),g(H,{key:c,width:"300px",height:"234px",class:"rounded-xl shadow-sm"}))),128)),u("div",Pt,[f(q,{variant:"text",style:{width:"300px",height:"234px"},class:"bg-green-50",onClick:E,loading:M.value,disabled:M.value},{icon:C(()=>d[4]||(d[4]=[u("i",{class:"pi pi-plus text-3xl"},null,-1)])),_:1},8,["loading","disabled"])])],512)):(a(),i("div",Lt,[ee.value.length>0?(a(),i("div",Et,[f(q,{icon:"pi pi-angle-left",onClick:F,class:"self-center",severity:"secondary"}),u("div",{ref_key:"scrollContainer",ref:_,class:"flex items-center flex-grow snap-x snap-mandatory overflow-x-auto max-w-screen gap-8"},[(a(!0),i(B,null,S(ee.value,c=>(a(),g(W,{key:c.id,project:c,id:c.id,class:"snap-start shrink-0 w-[300px]"},null,8,["project","id"]))),128)),(a(!0),i(B,null,S(A.value-P.value.length,c=>(a(),g(H,{key:c,width:"300px",height:"234px",class:"rounded-xl shadow-sm shrink-0 w-[300px]"}))),128))],512),f(q,{icon:"pi pi-angle-right",onClick:N,class:"self-center",severity:"secondary"})])):m("",!0),u("div",Xt,[d[5]||(d[5]=u("div",{class:"text-2xl pr-4"},"Practice",-1)),f(ne)]),u("div",Yt,[(a(!0),i(B,null,S(ke.value,c=>(a(),g(W,{key:c.id,project:c,onAfterRemove:T},null,8,["project"]))),128)),(a(!0),i(B,null,S(I.value-L.value.length,c=>(a(),g(H,{key:c,width:"300px",height:"234px",class:"rounded-xl shadow-sm"}))),128))])]))])}}});export{Qt as default};
