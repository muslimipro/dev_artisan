import{B as pe,z as he,aY as Me,x as r,R as me,O as Pe,o,c,e as h,P as M,f as g,D as H,Q as le,h as m,t as x,Y as re,a1 as R,M as A,aG as B,L as ce,a7 as Ve,a9 as ze,V as U,aa as Ee,ab as Ae,a6 as Be,ah as Fe,v as j,w as O,b as L,al as Ke,y as K,F as C,i as de,g as De,d as ge,a as fe,C as N,u as Re,p as Ue,r as F,I as Z,m as He,Z as je,j as p,k as be,s as Ne,aZ as Ze,_ as Je}from"./index-JgWrQ8Hv.js";import{a as We,s as Ye}from"./index-DDN_3RID.js";import{s as qe}from"./index-Dkp2gYG-.js";import{i as Ge}from"./index-CAuvA3b5.js";import{S as J}from"./index-DzWXQJQ1.js";import{a as Qe}from"./index-C2EhEmf4.js";import{u as Xe}from"./profile-7O_nmlQq.js";import{T as $e}from"./index-BBsTdB2u.js";var et=function(t){var e=t.dt;return`
.p-menu {
...
`)},ft={root:{position:"relative"}},bt={root:function(t){var e=t.instance,s=t.props;return["p-toggleswitch p-component",{"p-toggleswitch-checked":e.checked,"p-disabled":s.disabled,"p-invalid":e.$invalid}]},input:"p-toggleswitch-input",slider:"p-toggleswitch-slider",handle:"p-toggleswitch-handle"},vt=pe.extend({name:"toggleswitch",theme:gt,classes:bt,inlineStyles:ft}),yt={name:"BaseToggleSwitch",extends:We,props:{trueValue:{type:null,default:!0},falseValue:{type:null,default:!1},readonly:{type:Boolean,default:!1},tabindex:{type:Number,default:null},inputId:{type:String,default:null},inputClass:{type:[String,Object],default:null},inputStyle:{type:Object,default:null},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:vt,provide:function(){return{$pcToggleSwitch:this,$parentInstance:this}}},we={name:"ToggleSwitch",extends:yt,inheritAttrs:!1,emits:["change","focus","blur"],methods:{getPTOptions:function(t){var e=t==="root"?this.ptmi:this.ptm;return e(t,{context:{checked:this.checked,disabled:this.disabled}})},onChange:function(t){if(!this.disabled&&!this.readonly){var e=this.checked?this.falseValue:this.trueValue;this.writeValue(e,t),this.$emit("change",t)}},onFocus:function(t){this.$emit("focus",t)},onBlur:function(t){var e,s;this.$emit("blur",t),(e=(s=this.formField).onBlur)===null||e===void 0||e.call(s,t)}},computed:{checked:function(){return this.d_value===this.trueValue}}},wt=["data-p-checked","data-p-disabled"],kt=["id","checked","tabindex","disabled","readonly","aria-checked","aria-labelledby","aria-label","aria-invalid"];function It(n,t,e,s,l,i){return o(),c("div",r({class:n.cx("root"),style:n.sx("root")},i.getPTOptions("root"),{"data-p-checked":i.checked,"data-p-disabled":n.disabled}),[h("input",r({id:n.inputId,type:"checkbox",role:"switch",class:[n.cx("input"),n.inputClass],style:n.inputStyle,checked:i.checked,tabindex:n.tabindex,disabled:n.disabled,readonly:n.readonly,"aria-checked":i.checked,"aria-labelledby":n.ariaLabelledby,"aria-label":n.ariaLabel,"aria-invalid":n.invalid||void 0,onFocus:t[0]||(t[0]=function(){return i.onFocus&&i.onFocus.apply(i,arguments)}),onBlur:t[1]||(t[1]=function(){return i.onBlur&&i.onBlur.apply(i,arguments)}),onChange:t[2]||(t[2]=function(){return i.onChange&&i.onChange.apply(i,arguments)})},i.getPTOptions("input")),null,16,kt),h("div",r({class:n.cx("slider")},i.getPTOptions("slider")),[h("div",r({class:n.cx("handle")},i.getPTOptions("handle")),[K(n.$slots,"handle",{checked:i.checked})],16)],16)],16,wt)}we.render=It;const Lt={class:"relative overflow-hidden w-full border-0 bg-transparent flex items-start p-2 pl-4 rounded-none cursor-pointer transition-colors duration-200"},Ot={class:"inline-flex flex-col items-start"},Ct={class:"font-bold"},xt={class:"text-sm"},St={key:0,class:"flex flex-col gap-1 px-2"},_t=["href","onClick"],Tt={class:"ml-2"},Mt=["href","target"],Pt={class:"ml-2"},Vt={class:"flex justify-between items-center mb-8"},zt={class:"flex justify-end gap-2"},Ht=ge({__name:"UserMenu",setup(n){const t=fe(),{user:e}=N(t),s=Re(),l=be(),{t:i}=Ue(),f=F(),{width:b}=Ge(),a=Z(()=>b.value<640),v=Z(()=>{const w=[{label:i("header.menu.settings"),icon:"pi pi-cog",route:"/settings/edit-profile"},{label:i("logOut"),icon:"pi pi-sign-out",command:async()=>{await l.replace({name:"login"}),await Qe.logout(),t.logout()}}],d=[{label:i("projects"),icon:"pi pi-stop",route:"/projects"},{label:i("modules"),icon:"pi pi-circle",route:"/modules"}];return a.value?[...d,...w]:w}),y=w=>{f.value.toggle(w)};async function k(w){const{data:d}=await J.changeView(w);t.setToken(d),t.setUser(d),window.location.reload()}const P=F(""),S=F(!1),V=F(!1);async function ke(){if(P.value.length!=0){V.value=!0;try{await J.joinClass(P.value),s.add({severity:"success",summary:"Joined to class!",life:2e3}),S.value=!1,window.location.reload()}catch(w){console.log(w),s.add({severity:"error",summary:"Join class failed!",detail:w,life:2e3})}finally{V.value=!1}}}const Y=Xe(),{fetchProfile:q}=Y,{verified:G,profile:Ie,loading:Le}=N(Y),Q=()=>{Le.value||q()};return He(()=>{q(),window.addEventListener("focus",Q)}),je(()=>{window.removeEventListener("focus",Q)}),(w,d)=>{const I=Ne,Oe=qe,Ce=Ze,xe=j("router-link"),Se=ye,_e=Ye,Te=Je,D=me;return o(),c(C,null,[p(G)?(o(),g(I,{key:1,type:"button",icon:"pi pi-ellipsis-v",onClick:y,"aria-haspopup":"true","aria-controls":"overlay_menu",size:"small",variant:"outlined",severity:"secondary",class:"border border-slate-300 bg-slate-50",style:{width:"34px"}})):(o(),g(Oe,{key:0,value:"1",severity:"danger",size:"small"},{default:O(()=>[L(I,{type:"button",icon:"pi pi-ellipsis-v",onClick:y,"aria-haspopup":"true","aria-controls":"overlay_menu",size:"small",variant:"outlined",severity:"secondary",class:"border border-slate-300 bg-slate-50",style:{width:"34px"}})]),_:1})),L(Se,{ref_key:"menu",ref:f,id:"overlay_menu",model:v.value,popup:!0},{start:O(()=>{var u,_,z,E,X,$,ee,te,ne,ie,oe,se;return[M((o(),c("button",Lt,[h("span",Ot,[h("span",Ct,x((u=p(e))==null?void 0:u.email),1),h("span",xt,x((_=p(e))==null?void 0:_.user_type),1)])])),[[D]]),["school_manager","super_admin"].includes(((z=p(e))==null?void 0:z.origin_user_type)??"student")?m("",!0):(o(),c("div",St,[((E=p(e))==null?void 0:E.user_type)!="teacher"&&((X=p(e))==null?void 0:X.origin_user_type)!="student"?(o(),g(I,{key:0,label:"Teacher mode",class:"w-full",size:"small",onClick:d[0]||(d[0]=T=>k("teacher"))})):m("",!0),(($=p(e))==null?void 0:$.user_type)!="student"?(o(),g(I,{key:1,label:"Student mode",class:"w-full",size:"small",onClick:d[1]||(d[1]=T=>k("student")),severity:"info"})):m("",!0),!["student","teacher"].includes(((ee=p(e))==null?void 0:ee.origin_user_type)??"student")&&((te=p(e))==null?void 0:te.user_type)!=((ne=p(e))==null?void 0:ne.origin_user_type)?(o(),g(I,{key:2,label:`${(ie=p(e))==null?void 0:ie.origin_user_type.replace(/_/g," ").replace(/^./,T=>T.toUpperCase())} mode`,class:"w-full",size:"small",onClick:d[2]||(d[2]=T=>{var ae;return k(((ae=p(e))==null?void 0:ae.origin_user_type)??"student")}),severity:"help"},null,8,["label"])):m("",!0),((oe=p(e))==null?void 0:oe.origin_user_type)=="student"&&((se=p(Ie))==null?void 0:se.class_name)==null?(o(),g(I,{key:3,label:"Join class",icon:"pi pi-user-plus",size:"small",variant:"outlined",onClick:d[3]||(d[3]=T=>S.value=!0)})):m("",!0)]))]}),item:O(({item:u,props:_})=>[u.route?(o(),g(xe,{key:0,to:u.route},{default:O(({href:z,navigate:E})=>[M((o(),c("a",r({href:z},_.action,{onClick:E}),[h("span",{class:H(u.icon)},null,2),h("span",Tt,x(u.label),1),!p(G)&&u.route.includes("settings")?(o(),g(Ce,{key:0,value:"1",severity:"danger",size:"small"})):m("",!0)],16,_t)),[[D]])]),_:2},1032,["to"])):M((o(),c("a",r({key:1,href:u.url,target:u.target},_.action),[h("span",{class:H(u.icon)},null,2),h("span",Pt,x(u.label),1)],16,Mt)),[[D]])]),_:1},8,["model"]),L(Te,{visible:S.value,"onUpdate:visible":d[6]||(d[6]=u=>S.value=u),modal:"",header:"Join class by code",closable:!1},{default:O(()=>[h("div",Vt,[L(_e,{type:"text",modelValue:P.value,"onUpdate:modelValue":d[4]||(d[4]=u=>P.value=u),placeholder:"Enter code"},null,8,["modelValue"])]),h("div",zt,[L(I,{type:"button",label:"Cancel",severity:"secondary",onClick:d[5]||(d[5]=u=>S.value=!1)}),L(I,{type:"button",label:"Join",onClick:ke,loading:V.value,disabled:V.value},null,8,["loading","disabled"])])]),_:1},8,["visible"])],64)}}}),jt=ge({__name:"StudentViewToggle",props:{path:{}},setup(n){const t=n,e=be(),s=fe(),{user:l}=N(s),i=Z({get:()=>{var f;return((f=l.value)==null?void 0:f.user_type)==="student"},set:async f=>{var a;const{data:b}=await J.changeView(f?"student":((a=l.value)==null?void 0:a.origin_user_type)??"student");s.setToken(b),s.setUser(b),t.path?e.push({path:t.path}):window.location.reload()}});return(f,b)=>{var y;const a=we,v=$e;return["editor","contributor"].includes(((y=p(l))==null?void 0:y.origin_user_type)??"")?M((o(),g(a,{key:0,modelValue:i.value,"onUpdate:modelValue":b[0]||(b[0]=k=>i.value=k)},null,8,["modelValue"])),[[v,"Student view"]]):m("",!0)}}});export{jt as _,Ht as a,ye as b,we as s};
