<<<<<<<< HEAD:assets/index-TCDlrK6i.js
import{I as s,b as e,e as r,k as g,S as t,W as i,l as c,V as l,h as d,t as p,X as u}from"./index-CT3SuH-z.js";var y=function(o){var n=o.dt;return`
========
import{I as s,b as e,e as r,k as g,S as t,W as i,l as c,V as l,h as d,t as p,X as u}from"./index-WkhxvbEp.js";var y=function(o){var n=o.dt;return`
>>>>>>>> 70afea0 (pibody, state, langs, create, paste, bar, lesson, view):assets/index-Cz7c2Ml7.js
.p-tag {
    display: inline-flex;
    align-items: center;
...
`)},b={root:function(o){var n=o.props;return["p-tag p-component",{"p-tag-info":n.severity==="info","p-tag-success":n.severity==="success","p-tag-warn":n.severity==="warn","p-tag-danger":n.severity==="danger","p-tag-secondary":n.severity==="secondary","p-tag-contrast":n.severity==="contrast","p-tag-rounded":n.rounded}]},icon:"p-tag-icon",label:"p-tag-label"},m=s.extend({name:"tag",theme:y,classes:b}),f={name:"BaseTag",extends:u,props:{value:null,severity:null,rounded:Boolean,icon:String},style:m,provide:function(){return{$pcTag:this,$parentInstance:this}}},k={name:"Tag",extends:f,inheritAttrs:!1};function v(a,o,n,h,$,w){return e(),r("span",t({class:a.cx("root")},a.ptmi("root")),[a.$slots.icon?(e(),g(i(a.$slots.icon),t({key:0,class:a.cx("icon")},a.ptm("icon")),null,16,["class"])):a.icon?(e(),r("span",t({key:1,class:[a.cx("icon"),a.icon]},a.ptm("icon")),null,16)):c("",!0),a.value!=null||a.$slots.default?l(a.$slots,"default",{key:2},function(){return[d("span",t({class:a.cx("label")},a.ptm("label")),p(a.value),17)]}):c("",!0)],16)}k.render=v;export{k as s};
